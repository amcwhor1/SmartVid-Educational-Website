    ...
    <nav class="navbar navbar-default navigation-login" id="LoginNav">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                ...
                <p class="navbar-text navbar-right actions"><a class="navbar-link login" href="main.php">Logout </a> <a class="btn btn-primary action-button" role="button" href="profDash.php">Home </a></p>
            </div>
        </div>
    </nav>
        ...
        <div class="col-md-8">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title" style="font-size:40px;">Chemistry 2150 - Section 03</h3></div>
