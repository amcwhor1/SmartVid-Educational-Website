...
<body id="body">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="nav navbar-nav">
                    <li class="active" role="presentation"><a href="Main.html">Main </a></li>
                    <li role="presentation"><a href="#">About </a></li>
                </ul>
                <p class="navbar-text navbar-right actions"><a class="navbar-link login" href="Main.html">Logout </a> <a class="btn btn-primary action-button" role="button" href="ProfDash.html">Home </a></p>
            </div>
        </div>
    </nav>
    <div id="head">
        <h1 class="text-primary" style="padding:0px;padding-bottom:-5px;margin:23px;height:0px;">What is SmartVid?</h1>
    ...
    <div>
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4"><i class="glyphicon glyphicon-upload" style="font-size:45px;padding-bottom:-12px;"></i>
                ...
                <div class="col-lg-4 col-md-4" id="account"><i class="glyphicon glyphicon-lock" style="font-size:45px;padding-bottom:-12px;"></i>
